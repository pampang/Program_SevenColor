...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6">
			<div class="col-md-3">
				<a href="/MSCMS/merchantQueryCommentAction.action" class="btn btn-default btn-block">全部</a>
			</div>
			<div class="col-md-3">
				<a href="/MSCMS/merchantQueryCommentNotReplyAction.action" class="btn btn-default btn-block">未回评</a>
			</div>
			<div class="col-md-3">
				<a href="/MSCMS/merchantQueryCommentAlreadyReplyAction.action" class="btn btn-success btn-block active">已回评</a>
			</div>
		</div>
