...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" action="/MSCMS/productModifyAction.action" method="post" enctype="multipart/form-data">
			...
			<fieldset class="col-md-offset-3 col-md-6">
				...
				<div class="form-wrap col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input class="form-control" type="text" name="product.name" value="${product.name }" id="product-name" placeholder="请输入产品名称">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input class="form-control" type="text" name="product.price" value="${product.price }" id="product-price" placeholder="请输入产品价格">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea class="form-control" name="product.introduction" rows="3" id="product-introduction">${product.introduction }</textarea>
						</div>
					</div>

					<div class="form-group">
						<label class="col-md-3 control-label">产品图片：</label>
						<div class="col-md-9" id="picture">
							<img id="img" src="${product.picture }" alt="">
