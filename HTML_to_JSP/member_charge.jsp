...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" action="/MSCMS/rechargeAction.action" method="post">
			...
			<fieldset class="col-md-offset-3 col-md-6">
				...
				<div class="form-wrap col-md-12">
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" id="cardNum" class="form-control" name="card.cardNumber" id="user-name" placeholder="请输入会员卡号">
						</div>
						<div class="col-md-2 text-center">
							<button id="readCard" type="button" class="btn btn-primary btn-block">读卡</button>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="money">实收金额：</label>
						<div class="col-md-9">
							<input type="text" class="form-control" name="recharge.amount" id="money" placeholder="请输入实收金额">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-md-offset-3 col-md-6 text-center">
						<button type="submit" class="btn btn-success btn-lg btn-block">确认无误，充值！</button>
					</div>
				</div>
			</fieldset>			
	...
	readCard.onclick = function(){
		...
		xhr.open("post", "readCardAction.action", false);
		xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		xhr.send("card.cardNumber=" + document.getElementById("cardNum").value);
	}
