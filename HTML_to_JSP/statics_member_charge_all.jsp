...
<body>
	...
	<div class="container">
		...
		<div class="btn-group form-group btn-group-sm center">
			<a href="/MSCMS/rechargeStatisticAction.action?pagination.pageNum=1&beginDate=<fmt:formatDate value="${beginDate}" type="date"/>&endDate=<fmt:formatDate value="${endDate}" type="date" />" class="btn btn-default"><span class="glyphicon glyphicon-fast-backward"></span></a>
			<c:forEach var="pageNum" begin="1" end="${ pagination.pageCount}" > 
				<a href="/MSCMS/rechargeStatisticAction.action?pagination.pageNum=${pageNum}&beginDate=<fmt:formatDate value="${beginDate}" type="date"/>&endDate=<fmt:formatDate value="${endDate}" type="date" />" class="btn btn-default">${pageNum}</a>
			</c:forEach>
			<a href="/MSCMS/rechargeStatisticAction.action?pagination.pageNum=${ pagination.pageCount}&beginDate=<fmt:formatDate value="${beginDate}" type="date"/>&endDate=<fmt:formatDate value="${endDate}" type="date" />" class="btn btn-default"><span class="glyphicon glyphicon-fast-forward"></span></a>
		</div>
